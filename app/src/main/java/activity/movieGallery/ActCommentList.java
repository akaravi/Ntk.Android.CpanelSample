...
public class ActCommentList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_movie_gallery_comment_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("MovieGalleryCommentList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("MovieGalleryCommentList");
    ...
    private void getData() {
        MovieGalleryCommentListRequest request = new MovieGalleryCommentListRequest();
        ...
        Observable<MovieGalleryCommentResponse> call = iMovieGallery.GetCommentList(headers, request);
