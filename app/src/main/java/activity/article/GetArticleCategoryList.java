        ...
        call.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Observer<ArticleCategoryResponse>() {
                    ...
                    public void onNext(ArticleCategoryResponse response) {
                        JsonDialog cdd = new JsonDialog(GetArticleCategoryList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(GetArticleCategoryList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
