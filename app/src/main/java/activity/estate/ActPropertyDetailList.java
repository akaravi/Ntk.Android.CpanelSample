...
public class ActPropertyDetailList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_estate_property_detail_list);
    ...
    private void getData() {
        EstatePropertyDetailListRequest request = new EstatePropertyDetailListRequest();
        ...
        RetrofitManager manager = new RetrofitManager(ActPropertyDetailList.this);
        IEstate iEstate = manager.getRetrofit(configStaticValue.ApiBaseUrl).create(IEstate.class);
        Map<String, String> headers = new HashMap<>();
        headers = configRestHeader.GetHeaders(this);
        headers.put("PackageName", EasyPreference.with(this).getString("packageName",""));
        Observable<EstatePropertyDetailListResponse> call = iEstate.GetPropertyDetailList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Observer<EstatePropertyDetailListResponse>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                    }

                    @Override
                    public void onNext(EstatePropertyDetailListResponse response) {
                        JsonDialog cdd = new JsonDialog(ActPropertyDetailList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActPropertyDetailList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
