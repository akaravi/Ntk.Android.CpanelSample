...
public class ActPropertyFavoriteList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void initialize() {
        lblLayout.setText("EstatePropertyFavoriteList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("EstatePropertyFavoriteList");
    ...
    private void getData() {
        EstatePropertyFavoriteListRequest request = new EstatePropertyFavoriteListRequest();
        ...
        call.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Observer<EstatePropertyFavoriteListResponse>() {
                    ...
                    @Override
                    public void onNext(EstatePropertyFavoriteListResponse response) {
                        JsonDialog cdd = new JsonDialog(ActPropertyFavoriteList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActPropertyFavoriteList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
