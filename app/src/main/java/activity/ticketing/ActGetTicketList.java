...
public class ActGetTicketList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_ticket_get_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("TicketingTaskList");
        ...
        call.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Observer<TicketingListResponse>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActGetTicketList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
