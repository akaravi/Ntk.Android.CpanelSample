...
public class ActGetCommentList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_biography_get_comment_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("BiographyCommentList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("BiographyCommentList");
        ...
        call.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Observer<BiographyCommentResponse>() {
                    ...
                    public void onNext(BiographyCommentResponse response) {
                        JsonDialog cdd = new JsonDialog(ActGetCommentList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActGetCommentList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
