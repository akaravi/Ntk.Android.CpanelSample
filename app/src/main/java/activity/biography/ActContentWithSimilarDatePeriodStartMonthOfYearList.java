...
public class ActContentWithSimilarDatePeriodStartMonthOfYearList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Button addButton;
    @BindView(R.id.MonthOfYear)
    EditText MonthOfYear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_biography_content_with_similar_date_period_start_month_of_year_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("BiographyContentWithSimilarDatePeriodStartMonthOfYearList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("BiographyContentWithSimilarDatePeriodStartMonthOfYearList");
    ...
    private void getData() {
        BiographyContentWithSimilarDatePeriodStartMonthOfYearListRequest request = new BiographyContentWithSimilarDatePeriodStartMonthOfYearListRequest();
        ...
        if (!MonthOfYear.getText().toString().matches("")) {
            if (MonthOfYear.getInputType() != InputType.TYPE_CLASS_NUMBER) {
                MonthOfYear.setError("Invalid info !!");
                progressBar.setVisibility(View.GONE);
                return;
            } else {
                request.MonthOfYear = Integer.valueOf(MonthOfYear.getText().toString());
            }
        } else {
            MonthOfYear.setError("Invalid info !!");
            progressBar.setVisibility(View.GONE);
        ...
        RetrofitManager manager = new RetrofitManager(ActContentWithSimilarDatePeriodStartMonthOfYearList.this);
        ...
        call.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Observer<BiographyContentResponse>() {
                    ...
                    public void onNext(BiographyContentResponse response) {
                        JsonDialog cdd = new JsonDialog(ActContentWithSimilarDatePeriodStartMonthOfYearList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActContentWithSimilarDatePeriodStartMonthOfYearList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
