...
public class ActGetCategoryTagList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_biography_get_category_tag_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("BiographyCategoryTagList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("BiographyCategoryTagList");
    ...
    private void getData() {
        BiographyCategoryTagRequest request = new BiographyCategoryTagRequest();
        ...
        RetrofitManager manager = new RetrofitManager(ActGetCategoryTagList.this);
        ...
        call.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Observer<BiographyCategoryTagResponse>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                    }

                    @Override
                    public void onNext(BiographyCategoryTagResponse response) {
                        JsonDialog cdd = new JsonDialog(ActGetCategoryTagList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActGetCategoryTagList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
