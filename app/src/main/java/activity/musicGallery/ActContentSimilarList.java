...
public class ActContentSimilarList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_music_gallery_content_similar_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("MusicGalleryContentSimilarList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("MusicGalleryContentSimilarList");
    ...
    private void getData() {
        MusicGalleryContentSimilarListRequest request = new MusicGalleryContentSimilarListRequest();
        ...
        Observable<MusicGalleryContentResponse> call = iMusicGallery.GetContentSimilarList(headers, request);
