...
public class ActCategoryTagList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_music_gallery_category_tag_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("MusicGalleryCategoryTagList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("MusicGalleryCategoryTagList");
    ...
    private void getData() {
        MusicGalleryCategoryTagRequest request = new MusicGalleryCategoryTagRequest();
        ...
        Observable<MusicGalleryCategoryTagResponse> call = iMusicGallery.GetCategoryTagList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Observer<MusicGalleryCategoryTagResponse>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                    }

                    @Override
                    public void onNext(MusicGalleryCategoryTagResponse response) {
