...
public class ActContentView extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_music_gallery_content_view);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("MusicGalleryContentView");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("MusicGalleryContentView");
    ...
    private void getData() {
        MusicGalleryContentViewRequest request = new MusicGalleryContentViewRequest();
        ...
        Observable<MusicGalleryContentResponse> call = iMusicGallery.GetContentView(headers, request);
