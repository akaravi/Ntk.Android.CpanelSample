...
public class ActGetContentOtherInfoList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_news_get_content_other_info_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("NewsContentOtherInfoList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("NewsContentOtherInfoList");
    ...
    private void getData() {
        ...
        call.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Observer<NewsContentOtherInfoResponse>() {
                    ...
                    @Override
                    public void onNext(NewsContentOtherInfoResponse response) {
